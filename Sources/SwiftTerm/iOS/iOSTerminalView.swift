...
open class TerminalView: UIScrollView, UITextInputTraits, UIKeyInput, UIScrollViewDelegate, TerminalDelegate {
    ...
    func updateScroller ()
    {
        ...
        // Instead of blindly scrolling to bottom, use ensureCaretIsVisible which accounts for keyboard
    ...
    */
    ...
    @objc public func ensureCaretIsVisible ()
    {
        ...
        if cursorBottom > visibleBottom {
            ...
            // Add 1 row padding to ensure cursor is visible above keyboard
            let newOffset = cursorBottom - visibleHeight + cellDimension.height
